...
```{r}
create_diagnostic_plots(fit_simple_balanced)
```
...
# posterior simple
# posterior weighted
posterior_simple <- plot_predictive_checks(fit_simple_balanced, sim_data, "Simple Sim", "posterior_pred_choice")
```
...
# posterior simple
# posterior weighted
posterior_simple <- plot_predictive_checks(fit_simple_real, rename_pre, "Simple", "posterior_pred_choice")
```
